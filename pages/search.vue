    ...
    <div class="app-search-results">
      <div class="app-search-results-listing">
        ...
        <nuxt-link v-for="home in homes" :key="home.objectID" :to="`/home/${home.objectID}`">
          <HomeRow class="app-house" :home="home" @mouseover.native="highlightMarker(home.objectID,true)"
...
export default {
  ...
  // watchQuery: ['Lat'], // watches 'Lat'query and run asyncData on changes
  async beforeRouteUpdate(to, from, next) {
    const data = await this.$dataApi.getHomeByLocation(to.query.lat, to.query.lng, to.query.start, to.query.end)
    console.log('data from url query in search pahe:', data)
  ...
  async asyncData({query, $dataApi}) {
    ...
    console.log('async data in search page', data)
    return {
