export default function (context, inject) {
	...
	function addScript() {
		...
		script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyDFRSuGpqoRqYBMVnwwuMT_eWn2q3_fsLk&libraries=places&callback=initGoogleMaps"
		script.async = true
